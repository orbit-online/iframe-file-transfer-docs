...
export const navigation: Array<NavGroup> = [
	...
	},
	{
		title: 'Receiver',
		links: [
			{ title: 'vanilla/receiver', href: '/api/vanilla/receiver' },
			{ title: 'react/receiver', href: '/api/react/receiver' },
			{ title: 'lib/receiver', href: '/api/lib/receiver' },
		],
	},
	{
		title: 'Sender',
		links: [
			{ title: 'vanilla/sender', href: '/api/vanilla/sender' },
			{ title: 'react/sender', href: '/api/react/sender' },
			{ title: 'lib/sender', href: '/api/lib/sender' },
		],
	},
];
